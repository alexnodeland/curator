...
use curator_core::{Checksum, KpId, Vault};
...
// curator-core (the proposals/v1 write primitive guards on them too);
// re-exported here so adapter callers keep one import path.
pub use curator_core::managed::{MANAGED_BEGIN, MANAGED_END};
